...
함수1(10, 20, 30, 40) //error가 발생하지 않는... 단점이죠
함수1(10, 20)//NaN //error가 발생하지 않습니다.
...
함수1(a=1, c=2) //a와 c에 값이 들어갈것이라 생각했지만 a와 a에 들어갑니다.

//roro 기법, 아래와 같은 식별 이슈가 있을 경우 object로 넘깁니다.
function runPython(user, time, code, lv){
  runPython('lee', 100, 'funcion...',3)
}
function runPython({user, time, code, lv}){
